...
export function SpeechIcon() {
  ...
  return (
    <main
      className={`fixed border border-gray-700 rounded-xl bg-gray-900 shadow-xl right-5 top-1/2 transform -translate-y-1/2 ${isActive
        ? "flex"
        : "hidden"} flex-col items-center justify-between p-4 max-w-[80px]`}
    >
